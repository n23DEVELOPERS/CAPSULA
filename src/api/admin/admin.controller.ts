...
export class AdminController {
  ...
  signIn(
    ...
    return this.auth.signInAdmin(signInDto.username, signInDto.password, res);
  }
  ...
  @Get()
  findAll() {
    return this.adminService.findAll({ where: { role: Roles.ADMIN } });
  }
  ...
  verifyApplication(
    ...
    return this.adminService.verifyApplication(
      id,
      body.isVerified,
      body.description,
    );
